...
const Project = ({ name, image, category, techstack, description, publisher, links }: project) => {
    ...
    return (
        <motion.div
            ...
            <div className="relative group rounded-lg bg-violet-50">
                <Image alt={name} width={1000} height={1000} className="max-w-full h-48 max-h-full object-fill object-top rounded-lg" src={image} />
            ...
            <div className="my-2 flex flex-col gap-3">
                ...
                <p className="text-sm text-gray-400"> <span className="font-medium">Description:</span> {description}</p>
                {category === "Publications" ? 
                    (
                        <p className="text-sm text-gray-400"> <span className="font-medium">Publisher:</span> {publisher}</p>
                    ) : null
                }
            </div>
