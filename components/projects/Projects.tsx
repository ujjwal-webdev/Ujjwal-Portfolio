...
const Projects = ({ projectsData }: Props) => {
    ...
    return (
        <SectionWrapper id="projects" className="mx-4 md:mx-0 min-h-screen">
            ...
            <div className="overflow-x-auto scroll-hide md:w-full max-w-screen-lg mx-auto mt-6 flex justify-between items-center gap-2 md:gap-3 bg-white dark:bg-grey-800 p-2 rounded-md">
